...
g.xaxis.set_ticks_position('bottom')   # 設定 x 軸的刻度
g.spines['bottom'].set_position(('data', 0))   # 設定 x 軸的位置

g.yaxis.set_ticks_position('left')   # 設定 y 軸的刻度
g.spines['left'].set_position(('data', 0))   # 設定 y 軸的位置
